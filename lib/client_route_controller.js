...
var verbose = false,
	setVerbose = function ( self ) {
		verbose = ( self.router.options.preload && self.router.options.preload.verbose );
	},
	verboseAndSupported = verbose && (typeof console === "object");

	Console = {
		info : function ( params ) {
			if ( verboseAndSupported ) console.info( params );
		},

		warn : function ( params ) {
			if ( verboseAndSupported ) console.warn( params );
		},

		error: function ( params ) {
			if ( verboseAndSupported ) console.error( params );
		}
	};
